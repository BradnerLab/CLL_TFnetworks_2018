...
# sys.path.insert(0,'/fshare/users/nueschm/scripts/pipeline_gaurav_CLL_TFnetworks')
...
def main():
    ...
    if options.enhancers and options.genome and options.output and options.name:
        ...
        if options.motifs:
            ...
            # motifConvertFile = '/fshare/users/nueschm/scripts/pipeline_gaurav_CLL_TFnetworks/annotations/MotifDictionary.txt'
            # motifDatabaseFile = '/fshare/users/nueschm/scripts/pipeline_gaurav_CLL_TFnetworks/annotations/VertebratePWMs.txt'
        ...
        # if genome == 'MM10':
        #     genomeDirectory = '/fshare/users/nueschm/Utils/MM10/chromosomes/'
        #     annotationFile = '/fshare/users/nueschm/scripts/pipeline-gaurav-ctrc/annotation/mm10_refseq.ucsc'
        #     TFfile = '/fshare/users/nueschm/scripts/pipeline_gaurav_CLL_TFnetworks/annotations/TFlist_NMid_mm10.txt'
        if genome == 'MM10':
